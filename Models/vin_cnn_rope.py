...
Original file is located at
    https://colab.research.google.com/drive/17U9hOpBjkyO_ZNpDapCygo6VVSvAEfE8
"""
...
class HybridViNRoPE(nn.Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool = 'cls', channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.5, rotary_position_emb = True):
        super().__init__()
